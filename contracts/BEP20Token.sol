...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  /* Custom field */ 
  uint256 private _token_per_eth;

  constructor(string memory token_name, string memory token_symbol, uint8 token_decimals, uint256 token_per_eth) public {
    _name = token_name;
  ...
  */
  ...
  /* Custom Funtions */
  // Buy and sell function with fixed ether value
